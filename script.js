const translations = {
    ru: {
        ...
        faq_a1: "Мы устанавливаем окна ПВХ. Любые размеры и цвета в Скалея.",
        faq_q2: "Делаете ли вы замеры?",
        faq_a2: "Да, бесплатный замер на объекте в Скалея.",
        ...
        // ===== SEO ТЕКСТ =====
        seo_title: "Окна и двери в Скалея — надежность и качество от SSE",
        ...
        seo_text2: "Оконные рамы из ПВХ, бронированные двери, окна, изготовленные на заказ. SSE — ваш надежный партнер в Скалея.",
