...
const products = [
    // ===== ДВЕРИ ПВХ =====
    { id: 1, category: "doors", subcategory: "doors-pvc", price: "€600", size: "120x210 cm", img: "../door-pvc-1.jpg", nameKey: "product_name_1" },
    { id: 2, category: "doors", subcategory: "doors-pvc", price: "€500", size: "87x210 cm", img: "../door-pvc-2.jpg", nameKey: "product_name_2" },
    { id: 3, category: "doors", subcategory: "doors-pvc", price: "€500", size: "90x210 cm", img: "../door-pvc-3.jpg", nameKey: "product_name_3" },
    { id: 23, category: "doors", subcategory: "doors-pvc", price: "€500", size: "90x210 cm", img: "../door-pvc-4.jpg", nameKey: "product_name_4" },

    // ===== ДВЕРИ МДФ =====
    { id: 4, category: "doors", subcategory: "doors-mdf", price: "€600", size: "102x216 cm", img: "../door-mdf-1.jpg", nameKey: "product_name_5" },
    { id: 5, category: "doors", subcategory: "doors-mdf", price: "€700", size: "92x214 cm", img: "../door-mdf-2.jpg", nameKey: "product_name_6" },
    { id: 6, category: "doors", subcategory: "doors-mdf", price: "€600", size: "102x216 cm", img: "../door-mdf-3.jpg", nameKey: "product_name_7" },
    { id: 7, category: "doors", subcategory: "doors-mdf", price: "€600", size: "96x216 cm", img: "../door-mdf-4.jpg", nameKey: "product_name_8" },
    { id: 8, category: "doors", subcategory: "doors-mdf", price: "€950", size: "82x216 cm", img: "../door-mdf-5.jpg", nameKey: "product_name_9" },

    // ===== ДВЕРИ ECORAIDO =====
    { id: 9, category: "doors", subcategory: "doors-ecoraido", price: "€850", size: "120x210 cm", img: "../door-eco-1.jpg", nameKey: "product_name_10" },
    { id: 10, category: "doors", subcategory: "doors-ecoraido", price: "€500", size: "90x210 cm", img: "../door-eco-2.jpg", nameKey: "product_name_11" },
    { id: 11, category: "doors", subcategory: "doors-ecoraido", price: "€1100", size: "120x210 cm", img: "../door-eco-4.jpg", nameKey: "product_name_12" },

    // ===== ДВЕРИ МЕЖКОМНАТНЫЕ =====
    { id: 12, category: "doors", subcategory: "doors-interior", price: "€250", size: "70x210,80x210,90x210 cm", img: "../door-interior-1.jpg", nameKey: "product_name_13" },
    { id: 13, category: "doors", subcategory: "doors-interior", price: "€250", size: "70x210,80x210,90x210 cm", img: "../door-interior-2.jpg", nameKey: "product_name_14" },
    { id: 14, category: "doors", subcategory: "doors-interior", price: "€100", size: "80x210,90x210 cm", img: "../door-interior-3.jpg", nameKey: "product_name_15" },
    { id: 15, category: "doors", subcategory: "doors-interior", price: "€250", size: "80x210 cm", img: "../door-interior-4.jpg", nameKey: "product_name_16" },

    // ===== ОКНА ПВХ =====
    { id: 16, category: "windows", subcategory: "windows-pvc", price: "Disponibile", size: "", img: "../window-pvc-1.jpg", nameKey: "product_name_17" },
    { id: 17, category: "windows", subcategory: "windows-pvc", price: "Disponibile", size: "", img: "../window-pvc-2.jpg", nameKey: "product_name_18" },
    { id: 18, category: "windows", subcategory: "windows-pvc", price: "Disponibile", size: "", img: "../window-pvc-3.jpg", nameKey: "product_name_19" },

    // ===== ОКНА ПВХ + РОЛЕТЫ =====
    { id: 19, category: "windows", subcategory: "windows-roller", price: "Su ordinazione", size: "", img: "../window-roller-1.jpg", nameKey: "product_name_20" },
   

    // ===== ПЕРСИАНЫ =====
    { id: 21, category: "persiane", subcategory: "persiane-all", price: "Su ordinazione", size: "", img: "../persiane-1.jpg", nameKey: "product_name_22" },

    // ===== МОСКИТНЫЕ СЕТКИ =====
    { id: 22, category: "nets", subcategory: "nets-all", price: "Su ordinazione", size: "", img: "../net-1.jpg", nameKey: "product_name_23" },
];
...
function getPriceText(price) {
    if (price === "Disponibile") return currentLang === 'it' ? "In stock" : "Disponibile";
    if (price === "Su ordinazione") return currentLang === 'it' ? "Su ordinazione" : "Su ordinazione";
    return price;
}
...
function renderProducts(category, subcategory) {
    ...
    if (showBadge) {
        html += `<div class="subcategory-badge"><span>${getBadgeText()}</span><div class="badge-social"><a href="https://t.me/SSE_Scalea" class="badge-social-link" target="_blank" title="Telegram"><img src="../icons8-telegram-logo-101.png" alt="Telegram"></a><a href="https://www.tiktok.com/@blindati.infissi" class="badge-social-link" target="_blank" title="TikTok"><img src="../icons8-tiktok-100.png" alt="TikTok"></a><a href="https://wa.me/393792275566" class="badge-social-link" target="_blank" title="WhatsApp"><img src="../icons8-whatsapp-logo-100.png" alt="WhatsApp"></a></div></div>`;
    }
